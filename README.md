...
Ed25519 is carried out on the Twisted Edwards curve edwards25519. The parameters are:
- equation: ax^2 + y^2 = 1 + d * x^2 * y^2
- a = -1
...
- l = 2^252 + 27742317777372353535851937790883648493 # order of G, = order of subgroup generated by base point / generator G 
- Gx = 15112221349535400772501151409588531511454012693041857206046113283949847762202 # x coodinate, base point / generator G
- Gy = 46316835694926478169428394003475163141307993866256225615783033603165251855960 # y coordinate, base point / generator G
...
- f = SHA512(secretKey); a = clamped(f[:32]); prefix = f[32:]
- A = a * G
